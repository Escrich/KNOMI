...
typedef struct {
    ...
    char moonraker_tool[7]; // "tool0", atento, está recibiendo el nombre de la impresora, en lugar de "tool0" Escrich
...
#define PREHEAT_2_BED    90
#define PREHEAT_2_LABEL "PETG:" STRINGIFY(PREHEAT_2_NOZZLE) "/" STRINGIFY(PREHEAT_2_BED) "℃"
#define PREHEAT_3_NOZZLE 255
#define PREHEAT_3_BED    110
#define PREHEAT_3_LABEL "ABS:" STRINGIFY(PREHEAT_3_NOZZLE) "/" STRINGIFY(PREHEAT_3_BED) "℃"
#define PREHEAT_4_NOZZLE 260
#define PREHEAT_4_BED    110
#define PREHEAT_4_LABEL "ASA:" STRINGIFY(PREHEAT_4_NOZZLE) "/" STRINGIFY(PREHEAT_4_BED) "℃"
#define PREHEAT_5_NOZZLE 240
